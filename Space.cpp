...
bool IsView(std::ostream& os = std::cout)
{
    os << "View: " << cool::pretty_type<View>() << '\n';

    os << "rank: " << +View::rank << '\n';
    os << "rank_dynamic: " << +View::rank_dynamic << '\n';
    os << "reference_type_is_lvalue_reference: " << +View::reference_type_is_lvalue_reference << '\n';

    os << "data_type: " << cool::pretty_type<typename View::data_type>() << '\n';
    os << "const_data_type: " << cool::pretty_type<typename View::const_data_type>() << '\n';
    os << "non_const_data_type: " << cool::pretty_type<typename View::non_const_data_type>() << '\n';
    os << "scalar_array_type: " << cool::pretty_type<typename View::scalar_array_type>() << '\n';
    os << "const_scalar_array_type: " << cool::pretty_type<typename View::const_scalar_array_type>() << '\n';
    os << "non_const_scalar_array_type: " << cool::pretty_type<typename View::non_const_scalar_array_type>() << '\n';

    os << "value_type: " << cool::pretty_type<typename View::value_type>() << '\n';
    os << "const_value_type: " << cool::pretty_type<typename View::const_value_type>() << '\n';
    os << "non_const_value_type: " << cool::pretty_type<typename View::non_const_value_type>() << '\n';

    os << "execution_space: " << cool::pretty_type<typename View::execution_space>() << '\n';
    ...
    os << "host_mirror_space: " << cool::pretty_type<typename View::host_mirror_space>() << '\n';

    os << "non_const_type: " << cool::pretty_type<typename View::non_const_type>() << '\n';
    os << "const_type: " << cool::pretty_type<typename View::const_type>() << '\n';
    os << "HostMirror: " << cool::pretty_type<typename View::HostMirror>() << '\n';


    os << "reference_type: " << cool::pretty_type<typename View::reference_type>() << '\n';
